...
# Определение namedtuple для хранения информации о файлах/каталогах
...
def collect_info(directory_path):
    """
    Собирает информацию о содержимом директории и записывает в лог.
    """
    ...
    for entry in os.listdir(directory_path):
        ...
        logging.info(
            f'{file_info.name} | {file_info.extension or "N/A"} | {"Directory" if file_info.is_directory else "File"} | {file_info.parent_directory}')


def main():
    parser = ArgumentParser(description="Сбор информации о содержимом директории.")
    ...
    try:
        ...
        print(f'Информация о содержимом директории "{directory_path}" записана в "directory_contents.log".')
